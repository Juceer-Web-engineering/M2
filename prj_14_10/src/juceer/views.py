...
def artist_detail_view (request, artist_id):			#shows a details about given artist
	...
	for i in range(len(qs_year)):
		...
		print(stat)
	trys = "<p> fuckfuckfuck {numb} \r\n bn </p>".format(numb = numb)
	template_name = 'juceer/detail_artist.html'
	context = {"object": qs[0], "number": numb, "mean": statistics.mean(qs_list), "median": statistics.median(qs_list), "std_deviation": std_deviation, "stat": stat, "doc":trys}
